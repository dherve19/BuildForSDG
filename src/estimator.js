const covid19ImpactEstimator = (data) => {
  const date = {
    ...
    impact: {
      ...
      hospitalBedsByRequestedTime: (data.totalHospitlBeds * 0.35)
       - data.reportedCases * 10 * 1024 * 0.15 > 0 ? 
        Math.ceil((data.totalHospitlBeds * 0.35) - data.reportedCases * 10 * 1024 * 0.15) : 
        Math.floor((data.totalHospitlBeds * 0.35) - data.reportedCases * 10 * 1024 * 0.15),
      ...
      dollarsInFlight: (data.reportedCases * 10 * 1024 * 0.65) * 
      data.region.avgDailyIncomePopulation * 30,
    },
    severeImpact: {
      ...
      hospitalBedsByRequestedTime: (data.totalHospitlBeds * 0.35) 
      - data.reportedCases * 10 * 1024 * 0.15 > 0 ? 
        Math.ceil((data.totalHospitlBeds * 0.35) - data.reportedCases * 50 * 1024 * 0.15) :
        Math.floor((data.totalHospitlBeds * 0.35) - data.reportedCases * 50 * 1024 * 0.15),
      ...
      dollarsInFlight: (data.reportedCases * 50 * 1024 * 0.65) *
       data.region.avgDailyIncomePopulation * 30,
    },
